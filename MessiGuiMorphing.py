...
######################################################################################################################################################
		if n-1 >= 1:
			...
			self.slDeltaY1.setTickInterval(20)
...
######################################################################################################################################################
		if n-1 >= 2:
			...
			self.slDeltaY2.setTickPosition(QtGui.QSlider.TicksBelow)
			self.slDeltaY2.setTickInterval(20)
...
######################################################################################################################################################
		if n-1 >= 3:
			...
			self.slDeltaY3.setTickInterval(20)
...
######################################################################################################################################################
		if n-1 >= 4:
			...
			self.slDeltaY4.setTickInterval(20)
...
######################################################################################################################################################
		if n-1 >= 5:
			...
			self.slDeltaY5.setTickInterval(20)
